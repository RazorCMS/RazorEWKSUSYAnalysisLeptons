...
TH2F* swissCrossInterpolate(const TH2F* hist, std::string firstInterpolationDirection);
...
TH2F* swissCrossRebin(TH2F* hist, std::string firstInterpolationDirection);
...
TH2F* swissCrossRebin(TH2F* hist, std::string firstInterpolationDirection)
{
  ...
  // use interpolation to re-fill histogram
  TH2F* histRebinnedInterpolated = swissCrossInterpolate(histRebinned, firstInterpolationDirection);
