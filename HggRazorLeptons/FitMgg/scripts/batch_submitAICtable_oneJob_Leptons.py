...
if __name__ == "__main__":
	...
	os.system("rm -rf "+work_directory+"AIC_output/inclusiveElectron")
        os.system("mkdir -p "+work_directory+"AIC_output/inclusiveMuon")
