...
int main( int argc, char* argv[] )
{
  ...
  TFile* fsmh = new TFile("/Users/cmorgoth/Work/data/SusyEWK/MC/SM_Higgs_1pb_weighted.root");
  assert(fsmh);
  ...
  //full mgg region
  //---------------
  TString bkgCut = "weight*pileupWeight*btagCorrFactor*triggerEffSFWeight*photonEffSF*" + kf + "*" + lumi + "*(" + cut + ")";
  ...
  //mgg signal region
  //-----------------
  TString bkgCutSR = "weight*pileupWeight*btagCorrFactor*triggerEffSFWeight*photonEffSF*" + kf + "*" + lumi + "*(" + massWindowCut + ")";
