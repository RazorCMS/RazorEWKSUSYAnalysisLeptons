...
float GetNs( std::string fname, int bin, std::string cat = "inclusiveElectron" );
float GetNsErr( std::string fname, int bin, std::string cat = "inclusiveElectron" );
//
...
int main( int argc, char* argv[] )
{
  ...
  std::ifstream input( "data/HggRazorLeptons2016Binning.txt", std::fstream::in );
